...
# Requires the value passed to `--data` to be a path to a directory that is similar in structure to https://github.com/alexolcott/imc-prosperity-4-backtester/tree/master/prosperity4bt/resources
